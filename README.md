...
### `v1.7.2` - 2026-08-05
- **Fixed**: Enforced `sRGBEncoding` (`tex.encoding = THREE.sRGBEncoding`) on aerial satellite textures in `aholo.js` and added sky dome hemisphere lighting to eliminate desaturated/washed-out terrain colors.
